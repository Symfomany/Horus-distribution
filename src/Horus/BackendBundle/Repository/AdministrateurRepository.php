...
class AdministrateurRepository extends EntityRepository
{
    ...
    public function findUser($uid = null)
    {
        $q = $this->getEntityManager()->createQuery('
                SELECT u
                FROM HorusBackendBundle:Users u
                WHERE u.id = :uid');
    ...
    public function loadUserByUsername($username)
    {
        ...
        try {
            ...
            throw new UsernameNotFoundException(sprintf('Unable to find an active admin BackendBundle:Users object identified by "%s".', $username), null, 0, $e);
        }
