...
namespace Horus\BackendBundle\Fixtures;
 ...
 * @package Horus\BackendBundle\Fixtures
 */
class LoadProductsDatas implements FixtureInterface,ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $category = $em->getRepository('HorusBackendBundle:Category')->find(10);
        $transport = $em->getRepository('HorusBackendBundle:Transports')->find(80);
        $fournisseur = $em->getRepository('HorusBackendBundle:Fournisseurs')->find(5);
        $marque = $em->getRepository('HorusBackendBundle:Marques')->find(5);
