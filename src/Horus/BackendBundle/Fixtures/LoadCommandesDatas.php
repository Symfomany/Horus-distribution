...
class LoadCommandesDatas implements FixtureInterface,ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $client = $em->getRepository('HorusBackendBundle:Client')->findOneByEmail('demo@horus.com');
        $transport = $em->getRepository('HorusBackendBundle:Transports')->findOneByTitle('UPS TRansport');
