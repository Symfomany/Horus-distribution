...
class NotificationsListener
{
    ...
    public function notify(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof Produit) {
            ...
            $soonbegin = $entityManager->getRepository('HorusBackendBundle:Produit')->getProductsSoonBegin();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Produit')->getProductsIsImagesNull();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Produit')->getProductsIsFournisseursNull();
        ...
        if ($entity instanceof Category) {
            ...
            $categoryquantity = $entityManager->getRepository('HorusBackendBundle:Category')->getCategoryIsProductNull();
            ...
            $categorydesactivate = $entityManager->getRepository('HorusBackendBundle:Category')->getCategoryIsDesactive();
        ...
        if ($entity instanceof Famille) {
            ...
            $famillequantity = $entityManager->getRepository('HorusBackendBundle:Famille')->getFamilleIsProductNull();
            ...
            $familledesactivate = $entityManager->getRepository('HorusBackendBundle:Famille')->getFamilleIsDesactive();
        ...
        if ($entity instanceof Page) {
            ...
            $pagequantity = $entityManager->getRepository('HorusBackendBundle:Page')->getNbArticle();
            ...
            $pagesdesactivate = $entityManager->getRepository('HorusBackendBundle:Page')->getPagesIsDesactive();
            ...
            $pageswait = $entityManager->getRepository('HorusBackendBundle:Page')->getPagesWait();
        ...
        if ($entity instanceof Article) {
            ...
            $pagesdesactivate = $entityManager->getRepository('HorusBackendBundle:Article')->getArticlesIsDesactive();
            ...
            $pageswait = $entityManager->getRepository('HorusBackendBundle:Article')->getArticlesWait();
        ...
        if ($entity instanceof Commandes) {
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Commandes')->getCommandesReapro();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Commandes')->getCommandesVirr();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Commandes')->getCommandesLiv();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Commandes')->getCommandesErreur();
            ...
            $quantity = $entityManager->getRepository('HorusBackendBundle:Commandes')->getCommandesPrepa();
        ...
        if ($entity instanceof Commentaire) {
            ...
            $pagesdesactivate = $entityManager->getRepository('HorusBackendBundle:Commentaire')->getCommentaireIsDesactive();
            ...
            $pageswait = $entityManager->getRepository('HorusBackendBundle:Commentaire')->getCommentaireWait();
        ...
        if ($entity instanceof Commercial) {
            ...
            $desactivation = $entityManager->getRepository('HorusBackendBundle:Commercial')->getCommercialIsDesactive();
            ...
            $soonbegin = $entityManager->getRepository('HorusBackendBundle:Commercial')->getCommercialSoonBegin();
            ...
            $soonbegin = $entityManager->getRepository('HorusBackendBundle:Commercial')->getCommercialSoonEnd();
