...
class CommandesProduit
{
     ...
     * Set produit
     *
     * @param Horus\BackendBundle\Entity\Produit $produit
     * @return CommandesProduit
     */
    public function setProduit(\Horus\BackendBundle\Entity\Produit $produit = null)
    {
     ...
     * @return CommandesProduit
     */
    public function setCommandes(\Horus\BackendBundle\Entity\Commandes $commandes = null)
    {
     ...
     * Get commandes
     *
     * @return Horus\BackendBundle\Entity\Commandes
     */
