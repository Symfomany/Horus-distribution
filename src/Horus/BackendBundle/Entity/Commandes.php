...
class Commandes
{
     ...
     *
     * @param Horus\BackendBundle\Entity\CommandesProduit $commandesProduit
     * @return Commandes
     */
    public function addCommandesProduit(\Horus\BackendBundle\Entity\CommandesProduit $commandesProduits)
    {
     ...
     * @param Horus\BackendBundle\Entity\CommandesProduit $commandesProduit
     */
    public function removeCommandesProduit(\Horus\BackendBundle\Entity\CommandesProduit $commandesProduits)
    {
