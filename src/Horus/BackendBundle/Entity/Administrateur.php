...
class Administrateur extends BaseUser {
     ...
     * Set metier
     *
     * @param \Horus\BackendBundle\Entity\Metier $metier
     * @return Administrateur
     */
    public function setMetier(\Horus\BackendBundle\Entity\Metier $metier = null)
    {
        $this->metier = $metier;
     ...
     * Get metier
     *
     * @return \Horus\BackendBundle\Entity\Metier
     */
