 ...
 * @ORM\Entity(repositoryClass="Horus\BackendBundle\Repository\PageRepository")
 * @ORM\Table(name="page")
...
class Page
{
     ...
     * @return Page
     */
    public function setParent(\Horus\BackendBundle\Entity\Page $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
     ...
     * @return Page
     */
    public function addChildren(\Horus\BackendBundle\Entity\Page $children)
    {
     ...
     * @param Horus\BackendBundle\Entity\Category $children
     */
    public function removeChildren(\Horus\BackendBundle\Entity\Page $children)
    {
