 ...
 * @ORM\Entity(repositoryClass="Horus\BackendBundle\Repository\CategoryRepository")
...
class Category
{
     ...
     * Add articless
     *
     * @param Horus\BackendBundle\Entity\Article $articless
     * @return Category
     */
    public function addArticles(\Horus\BackendBundle\Entity\Article $articless)
    {
     ...
     * @param Horus\BackendBundle\Entity\Article $articless
     */
    public function removeArticles(\Horus\BackendBundle\Entity\Article $articless)
    {
     ...
     * Set parent
     *
     * @param Horus\BackendBundle\Entity\Category $parent
     * @return Category
     */
    public function setParent(\Horus\BackendBundle\Entity\Category $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
     ...
     * Add children
     *
     * @param Horus\BackendBundle\Entity\Category $children
     * @return Category
     */
    public function addChildren(\Horus\BackendBundle\Entity\Category $children)
    {
     ...
     * @param Horus\BackendBundle\Entity\Category $children
     */
    public function removeChildren(\Horus\BackendBundle\Entity\Category $children)
    {
     ...
     * Add images
     *
     * @param Horus\BackendBundle\Entity\ImageCategory $images
     * @return Category
     */
    public function addImage(\Horus\BackendBundle\Entity\ImageCategory $images)
    {
        $this->images[] = $images;
        return $this;
    }
     ...
     * @param Horus\BackendBundle\Entity\ImageCategory $images
     */
    public function removeImage(\Horus\BackendBundle\Entity\ImageCategory $images)
    {
