 ...
 * @ORM\Entity(repositoryClass="Horus\BackendBundle\Repository\ClientRepository")
 */
...
//    Reccurrente function
     ...
     * Set cart
     *
     * @param Horus\BackendBundle\Entity\Cart $cart
     * @return Client
     */
    public function setCart(\Horus\BackendBundle\Entity\Cart $cart = null)
    {
        $this->cart = $cart;
        return $this;
    }
     ...
     * Get cart
     *
     * @return Horus\BackendBundle\Entity\Cart
     */
     ...
     * Add client
     *
     * @param Horus\BackendBundle\Entity\Commentaire $client
     * @return Client
     */
    public function addClient(\Horus\BackendBundle\Entity\Commentaire $client)
    {
        $this->client[] = $client;
        return $this;
    }
     ...
     * @param Horus\BackendBundle\Entity\Commentaire $client
     */
    public function removeClient(\Horus\BackendBundle\Entity\Commentaire $client)
    {
     ...
     * Add addresses
     *
     * @param Horus\BackendBundle\Entity\Addresses $addresses
     * @return Client
     */
    public function addAddresse(\Horus\BackendBundle\Entity\Addresses $addresses)
    {
     ...
     * @param Horus\BackendBundle\Entity\Addresses $addresses
     */
    public function removeAddresse(\Horus\BackendBundle\Entity\Addresses $addresses)
    {
     ...
     * Add commandes
     *
     * @param Horus\BackendBundle\Entity\Commandes $commandes
     * @return Client
     */
    public function addCommande(\Horus\BackendBundle\Entity\Commandes $commandes)
    {
     ...
     * @param Horus\BackendBundle\Entity\Commandes $commandes
     */
    public function removeCommande(\Horus\BackendBundle\Entity\Commandes $commandes)
    {
