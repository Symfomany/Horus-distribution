 ...
 * @ORM\Entity(repositoryClass="Horus\BackendBundle\Repository\FournisseursRepository")
...
//        $this->path = sha1(uniqid(mt_rand(), true)).'.'.$this->file->guessExtension();
     ...
     * Add fournisseurs
     *
     * @param Horus\BackendBundle\Entity\Produit $fournisseurs
     * @return Fournisseurs
     */
    public function addFournisseur(\Horus\BackendBundle\Entity\Produit $fournisseurs)
    {
     ...
     * @param Horus\BackendBundle\Entity\Produit $fournisseurs
     */
    public function removeFournisseur(\Horus\BackendBundle\Entity\Produit $fournisseurs)
    {
