 ...
 * @ORM\Entity(repositoryClass="Horus\BackendBundle\Repository\FamilleRepository")
...
class Famille
{
     ...
     * @return Famille
     */
    public function setParent(\Horus\BackendBundle\Entity\Famille $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
     ...
     * @return Famille
     */
    public function addChildren(\Horus\BackendBundle\Entity\Famille $children)
    {
     ...
     * @param Horus\BackendBundle\Entity\Category $children
     */
    public function removeChildren(\Horus\BackendBundle\Entity\Famille $children)
    {
