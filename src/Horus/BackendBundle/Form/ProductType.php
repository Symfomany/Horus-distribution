...
class ProductType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('category', null, array('required' => true, 'property' => 'optionLabel', "attr" => array('class' => "select2")))
            ->add('isShop')
            ->add('accesories')
            ->add('cates', null, array('property' => 'optionLabel', "attr" => array('class' => "select2")))
            ->add('articles', null, array( "attr" => array('class' => "select2")))
            ->add('marque', 'entity', array(
                'required' => false,
                'empty_value' => 'Choisissez une marque',
                'class' => 'HorusBackendBundle:Marques',
                'property' => 'OptionLabel',
                "attr" => array('class' => "select2")
            ))
            ->add('fournisseur', null, array("attr" => array('class' => "select2")))
            ->add('tags', null, array("attr" => array('class' => "select2")))
            ->add('familles', null, array("attr" => array('class' => "select2")))
            ->add('prodparent', null, array('empty_value' => 'Choisissez un produit' , "attr" => array('class' => "select2")))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $resolver->setDefaults(array(
            'data_class' => 'Horus\BackendBundle\Entity\Produit',
