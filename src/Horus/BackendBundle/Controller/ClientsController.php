...
use Horus\BackendBundle\Entity\Client;
use Horus\BackendBundle\Form\ClientsAdressesType;
use Horus\BackendBundle\Form\ClientsType;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Horus\BackendBundle\Entity\Clients;
...
class ClientsController extends Controller
{
    ...
    {
        return $this->render('HorusBackendBundle:Commandes:factures.html.twig');
    }
    ...
    {
        return $this->render('HorusBackendBundle:Commandes:commandes.html.twig');
    }
    ...
    {
        return $this->render('HorusBackendBundle:Clients:commentaires.html.twig');
    }
    ...
    public function clientsAction()
    {
        ...
        $clients = $em->getRepository('HorusBackendBundle:Client')->findAll();
        ...
        return $this->render('HorusBackendBundle:Clients:clients.html.twig', array('clients' => $pagination));
    }
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $clients = $em->getRepository('HorusBackendBundle:Client')->findAll(array(), array('cateCreated' => 'DESC', 7));
        return $this->render('HorusBackendBundle:Clients:lastclients.html.twig', array('clients' => $clients));
    }
    ...
    {
        $em = $this->getDoctrine()->getManager();
        return $this->render('HorusBackendBundle:Clients:client.html.twig', array('client' => $id));
    }
    ...
    public function commandesclientAction(Client $id)
    {
        ...
        return $this->render('HorusBackendBundle:Clients:clientcommande.html.twig',
            array(
                'client' => $id,
    ...
    public function adressesclientAction(Client $id)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->render('HorusBackendBundle:Clients:adresses.html.twig',
            array(
                'client' => $id,
    ...
    {
        return $this->render('HorusBackendBundle:Clients:panierclient.html.twig',
            array(
                'client' => $id,
                'panier' => $id->getCart()
            ));
    ...
    {
        return $this->render('HorusBackendBundle:Clients:client.html.twig',
            array(
                'client' => $id,
                'addresses' => $id->getAddresses()
            ));
...
//        }
        ...
        return $this->render('HorusBackendBundle:Clients:createclient.html.twig', array('form' => $form->createView()));
    }
...
//        }
        ...
        return $this->render('HorusBackendBundle:Clients:editclient.html.twig', array('form' => $form->createView(), 'client' => $id));
    }
    ...
    {
        return $this->render('HorusBackendBundle:Commandes:panier.html.twig');
    }
