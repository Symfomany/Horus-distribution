...
class MediasController extends Controller
{
    ...
    public function mediasAction()
    {
        ...
        $medias = $em->getRepository('HorusBackendBundle:Image')->findAll();
        $mediascat = $em->getRepository('HorusBackendBundle:ImageCategory')->findAll();
        ...
        return $this->render('HorusBackendBundle:Medias:medias.html.twig', array(
            'medias' => $pagination,
