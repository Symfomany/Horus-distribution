...
use Horus\BackendBundle\Entity\Transports;
use Horus\BackendBundle\Form\TransportType;
...
class TransportsController extends Controller
{
    ...
    public function transportsAction()
    {
        ...
        $transports = $em->getRepository('HorusBackendBundle:Transports')->findAll();

        return $this->render('HorusBackendBundle:Transports:transports.html.twig',
    ...
    public function createtransportAction()
    {
        ...
        return $this->render('HorusBackendBundle:Transports:createtransport.html.twig',
            array(
    ...
    public function edittransportAction(Transports $id)
    {
        ...
        return $this->render('HorusBackendBundle:Transports:edittransport.html.twig',
            array(
                'form' => $form->createView(),
                'transport' => $id
            )
