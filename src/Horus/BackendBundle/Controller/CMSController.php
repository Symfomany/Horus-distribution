...
class CMSController extends Controller
{
    ...
    public function tagsAction()
    {
        ...
        $tags = $em->getRepository('HorusBackendBundle:Tag')->findAll();
        ...
        return $this->render('HorusBackendBundle:CMS:tags.html.twig', array('tags' => $pagination));
    }
    ...
    public function createtagAction()
    {
        ...
        return $this->render('HorusBackendBundle:CMS:createtag.html.twig',
            array(
    ...
    public function edittagAction(Tag $id)
    {
        ...
        return $this->render('HorusBackendBundle:CMS:edittag.html.twig',
            array(
                'form' => $form->createView(),
                'tag' => $id,
            )
    ...
    public function pagesAction()
    {
        ...
        $pages = $em->getRepository('HorusBackendBundle:Page')->findBy(array('nature' => $nature));
        $isarticle = $em->getRepository('HorusBackendBundle:Page')->isArticle();
        ...
        $nbvalider = $em->getRepository('HorusBackendBundle:Page')->getCountValidPages(3);
        $nbvalidating = $em->getRepository('HorusBackendBundle:Page')->getCountValidPages(2);
        $nbnovalidate = $em->getRepository('HorusBackendBundle:Page')->getCountValidPages(1);
        ...
        return $this->render('HorusBackendBundle:CMS:pages.html.twig', array(
            'pages' => $pagination,
            'nbvalider' => $nbvalider,
    ...
    public function articlesAction()
    {
        $em = $this->getDoctrine()->getManager();
        $nature = $this->container->get('request')->get('nature', array(1,2,3));
        $articles = $em->getRepository('HorusBackendBundle:Article')->findBy(array('nature' => $nature));

        $isPage = $em->getRepository('HorusBackendBundle:Article')->isPage();
        ...
        $nbvalider = $em->getRepository('HorusBackendBundle:Article')->getCountValidArticles(3);
        $nbvalidating = $em->getRepository('HorusBackendBundle:Article')->getCountValidArticles(2);
        $nbnovalidate = $em->getRepository('HorusBackendBundle:Article')->getCountValidArticles(1);
        ...
        return $this->render('HorusBackendBundle:CMS:articles.html.twig', array(
            'articles' => $pagination,
            'nbvalider' => $nbvalider,
            'nbvalidating' => $nbvalidating,
            'nbnovalidate' => $nbnovalidate
    ...
    public function createarticleAction()
    {
        ...
        return $this->render('HorusBackendBundle:CMS:createarticle.html.twig',
            array(
                'form' => $form->createView(),
            )
        );
    ...
    public function editarticleAction(Article $id)
    {
        ...
        return $this->render('HorusBackendBundle:CMS:editarticle.html.twig',
            array(
                'form' => $form->createView(),
                'article' => $id,
            )
    ...
    {
        return $this->render('HorusBackendBundle:CMS:article.html.twig',
            array(
                'category' => $id,
            )
        );
    ...
    {
        return $this->render('HorusBackendBundle:CMS:articlecommentaires.html.twig',
            array(
                'article' => $id,
    ...
    public function createPageAction()
    {
        ...
        if(!empty($idarg)){
            $Page = $em->getRepository('HorusBackendBundle:Page')->find($idarg);
        }
        ...
        return $this->render('HorusBackendBundle:CMS:createpage.html.twig',
            array(
                'form' => $form->createView(),
            )
        );
    ...
    public function editpageAction(Page $id)
    {
        ...
        return $this->render('HorusBackendBundle:CMS:editpage.html.twig',
            array(
                'form' => $form->createView(),
                'page' => $id,
                'video' => $media
    ...
    {
        return $this->render('HorusBackendBundle:CMS:page.html.twig',
            array(
                'category' => $id,
            )
        );
